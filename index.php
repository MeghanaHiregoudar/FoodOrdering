...
<head>
    ...
    <body>
        <?php $banner_res = mysqli_query($conn,"SELECT * FROM `banner` WHERE `status` = 1 ORDER BY `order_number`"); ?>
                    ...
                    <div class="container">
                        <div class="slider-content slider-animated-1">
                            ...
                            <div class="slider-btn mt-90">
                                <a class="animated" href="<?php echo FRONT_SITE_PATH.$banner_row['link']; ?>"><?php echo $banner_row['link_text']; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
