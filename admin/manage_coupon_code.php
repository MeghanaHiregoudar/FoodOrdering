...
if(isset($_POST['submit'])){
	...
	if(mysqli_num_rows(mysqli_query($conn,$sql))>0){
		...
		if($id==''){
			mysqli_query($conn,"insert into coupon_code(coupon_code,coupon_type,coupon_value,cart_min_value,expired_on,added_on) values('$coupon_code','$coupon_type','$coupon_value','$cart_min_value','$expired_on','$added_on')");
		}else{
